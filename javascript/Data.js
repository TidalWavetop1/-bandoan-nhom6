...
document.addEventListener('DOMContentLoaded', function () {
    let listDonHang = [
        { Madon: 1, Makhach: 1, Manhanvien: 7, sanPhamMua: [{ ID: 1, SLmua: 1 }, { ID: 2, SLmua: 1 }], Thoigian: "11-1-2024", Thanhtien: 83000, PTTT: "Tiền mặt", Diachi: "abc, p.16, q.5, tpHCM", Trangthai: "Đã xác nhận" },
        { Madon: 2, Makhach: 2, Manhanvien: 7, sanPhamMua: [{ ID: 2, SLmua: 2 }], Thoigian: "11-2-2024", Thanhtien: 66000, PTTT: "Zalopay", Diachi: "xyz, p.5, q.6, tpHCM", Trangthai: "Đã xác nhận" },
        { Madon: 3, Makhach: 3, Manhanvien: 8, sanPhamMua: [{ ID: 1, SLmua: 3 }], Thoigian: "11-3-2024", Thanhtien: 150000, PTTT: "Tiền mặt", Diachi: "abc, p.16, q.5, tpHCM", Trangthai: "Chưa xử lí" },
        { Madon: 4, Makhach: 4, Manhanvien: 7, sanPhamMua: [{ ID: 2, SLmua: 1 }], Thoigian: "11-4-2024", Thanhtien: 33000, PTTT: "Thẻ tín dụng", Diachi: "xyz, p.4, q.7, tpHCM", Trangthai: "Đã xác nhận" },
        { Madon: 5, Makhach: 5, Manhanvien: 8, sanPhamMua: [{ ID: 1, SLmua: 2 }], Thoigian: "11-5-2024", Thanhtien: 100000, PTTT: "Tiền mặt", Diachi: "abc, p.16, q.5, tpHCM", Trangthai: "Đã xác nhận" },
        { Madon: 6, Makhach: 6, Manhanvien: 8, sanPhamMua: [{ ID: 2, SLmua: 3 }], Thoigian: "11-6-2024", Thanhtien: 99000, PTTT: "Zalopay", Diachi: "xyz, p.5, q.6, tpHCM", Trangthai: "Chưa xử lí" }
    ];
    ...
    localStorage.setItem('products', JSON.stringify([
        ...
        { ID: 26, name: "Bắp Cải Trộn (Lớn)", price: 120000, img: "image/Product_Menu/Bắp Cảii Trộn (Lớn).png", category: "Bắp Cải", quantity: 100, description: "" },
    ...
    let listUsers = [
        ...
        { Manguoidung: 7, Tennguoidung: "Trương price G", SDT: "09182665710", Email: "GiaG@gmail.com", Diachi: "jgk, p.10, q.1, tpHCM", Trangthai: "Hoạt động", Username: "truonggiag", Password: "truonggiag123", Chucvu: "Nhân viên" },
