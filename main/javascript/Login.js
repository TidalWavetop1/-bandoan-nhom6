...
function showAccountInfo(){
    document.getElementById("account-name").textContent = "Tên đăng nhập: " + USER_CREDENTIALS.username;
    document.getElementById("account-password").textContent = "Mật khẩu: " + USER_CREDENTIALS.password;
